 ...
 * interface.
 */
public class Oddsfrag extends ListFragment {


    public static final String TAG = Oddsfrag.class.getSimpleName();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.oddfrag_layout, container, false);
